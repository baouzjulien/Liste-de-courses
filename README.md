...
Une petite application web pour gérer une liste de courses avec des rayons et des produits, synchronisée via Google Sheets. Optimisée pour un usage mobile et desktop. synchronisation depuis API au raffraichissement de la page.
